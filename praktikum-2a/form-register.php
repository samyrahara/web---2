        ...
        <fieldset class="border border-dark p-3 rounded" style="background-color: lightyellow;">
            ...
            <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="nim" name="nim" placeholder="*0110124033" type="text" class="form-control" required="required" pattern="[0-9]{10}" title="NIM harus 10 digit Angka">
                </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="nama_lengkap" name="nama_lengkap" placeholder="*Marissa Azzahra" type="text" class="form-control" required="required" minlength="3" maxlength="50">
                </div>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="custom-control custom-radio custom-control-inline">
                    <input name="jenis_kelamin" id="jenis_kelamin_0" type="radio" class="custom-control-input" value="perempuan" required="required" checked > 
            ...
            <div class="form-group row">
                ...
                <div class="input-group">
                    ...
                    <input id="email" name="&quot;contoh@gmail.com" type="email" class="form-control" required="required">
                </div>
                </div>
            </div> 
            <div class="form-group row">
