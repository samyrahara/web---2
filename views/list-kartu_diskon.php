                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <table id="datatableSimple" class="table table-bordered">
                                ...
                                <tbody>
                                    <?php foreach ($KartuDiskon as $KartuDiskon => $KartuDiskon): ?>
                                        <tr>
                                            <td><?= $KartuDiskon['id'] ?></td>
                                            <td><?= $KartuDiskon['nama'] ?></td>
                                            <td><?= $KartuDiskon['deskripsi'] ?></td>
                                            <td><?= $KartuDiskon['persen_diskon'] ?></td>
                                            <td>
                                                <a href="detail-kartu_diskon.php?id=<?= $KartuDiskon['id'] ?>" class="btn btn-primary btn-sm"><i class="fas fa-eye"></i> Detail</a>
                                                <a href="edit-Kartu_diskon.php?id=<?= $KartuDiskon['id'] ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                                <a href="delete-kartu_diskon.php?id=<?= $KartuDiskon['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus Pembayarank ini?');"><i class="fas fa-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
